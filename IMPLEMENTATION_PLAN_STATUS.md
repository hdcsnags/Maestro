...
| DIFF-03 | — | spec ready | 2026-05-04 | See `DIFF-03_LANE_SLICING_SPEC.md`. Lane-scoped prompt slicing. Depends on REL-01 (✅ done). Unblocks DIFF-04. Opus reviews steps 3 (architect prompt) + 4 (cross-lane validation) before merge. |
