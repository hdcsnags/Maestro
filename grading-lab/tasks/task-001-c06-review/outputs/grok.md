I'll start by reading `TASK.md` and the context files it references.
Reading the relevant sections of `useBuildExecution.ts` to see how the conductor is wired and what data flows into reconciliation.
